...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title=messagebox,message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    ...
    messagebox.showinfo(title='sus', message=story)
